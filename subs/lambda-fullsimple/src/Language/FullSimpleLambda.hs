...
eval (TmApp (TmLam x _ t1) v2@(isValue -> True)) = shift 0 (-1) $ subst 0 (shift 0 1 v2) t1-- E-APPABS
...
eval (TmLet x v1@(isValue -> True) t2) = shift 0 (-1) $ subst 0 (shift 0 1 v1) t2 -- E-LETV
